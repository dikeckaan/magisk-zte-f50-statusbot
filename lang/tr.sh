...
Uygulanınca cihaz REBOOT olacak."
    ...
    [desc_ussd]="USSD kisa kod calistir - /ussd *123#"
  ...
  Manifest: https://github.com/dikeckaan/f50-magisk-modules/blob/main/modules.json"
    ...
    [ussd_usage]="Kullanim: /ussd <kod>  (or. /ussd *123#)"
    [ussd_request_fmt]="📞 USSD: %s ..."
    [ussd_response_fmt]="📞 Yanit:\n%s"
    [ussd_multistep_fmt]="📞 Cok adimli yanit (devam icin /ussd <yanit>):\n%s"
    [ussd_failed_fmt]="❌ USSD basarisiz: %s"
