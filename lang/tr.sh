...
Uygulanınca cihaz REBOOT olacak."
    ...
    [desc_install]="Opsiyonel modul kur - /install [list|<id>]"
    ...
    # ─── /install — opsiyonel modul yukleyici ────────────────────────
    [install_list_header]="📦 Opsiyonel moduller"
    [install_list_installed_fmt]="  ✅ %s  (kurulu)"
    [install_list_available_fmt]="  ⬇  %s  (kurulabilir — /install %s)"
    [install_usage]="Kullanim:\n  /install <id>   — GitHub'dan modulu kur\n  /install list   — bu listeyi goster\n  Kisaltma: adguard → adguardhome, traffic → traffic-stats"
    [install_unknown_fmt]="❌ Bilinmeyen modul: %s. /install list deneyin."
    ...
    [agh_stopped]="🛡 Durduruldu. br0 uzerindeki iptables NAT yonlendirmesi duruyor — kaldirmak icin modulu disable edin."
