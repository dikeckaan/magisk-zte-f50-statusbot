...
On confirmation the device will REBOOT."
    ...
    [desc_ussd]="Run a USSD shortcode - /ussd *123#"
  ...
  Manifest: https://github.com/dikeckaan/f50-magisk-modules/blob/main/modules.json"
    ...
    [ussd_usage]="Usage: /ussd <code>  (e.g. /ussd *123#)"
    [ussd_request_fmt]="📞 USSD: %s ..."
    [ussd_response_fmt]="📞 Response:\n%s"
    [ussd_multistep_fmt]="📞 Multi-step response (use /ussd <reply> to continue):\n%s"
    [ussd_failed_fmt]="❌ USSD failed: %s"
